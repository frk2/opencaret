...
class ObstacleTracker():
    ...
    def __init__(self):
        self.radar_sub = rospy.Subscriber('/radar_tracks', RadarTracks, self.on_radar_tracks)
        self.obstacle_pub = rospy.Publisher('/obstacles', Obstacles, queue_size=1)
        self.lead_obstacle = rospy.Publisher('/lead_obstacle', Obstacle, queue_size=1)
        self.all_obstacles = []
    ...
    def on_radar_tracks(self, tracks_msg):
        ...
        if len(points_list) > 0:
            ...
            rospy.logdebug("Raw: {}".format(points_list))
