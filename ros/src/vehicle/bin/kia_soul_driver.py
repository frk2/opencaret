...
class KiaSoulDriver():
    ...
    def on_long_target(self, target):
        self.can_bus.send_message(arbitration_id=0x94, data=struct.pack('ff',
                                                                        float(target.speed),
                                                                        float(target.accel)))
    ...
    def on_steering_angle_target(self, msg):
        ...
        self.can_bus.send_message(id=0x84,
                                data=steering_oscc_msg.encode({
                                    ...
                                    'steering_command_torque_request': msg.data * KIA_SOUL_STEERING_RATIO,
